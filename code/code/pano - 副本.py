...
class Stitch:
	def __init__(self, args):
		...
		print (filenames)
		self.images = [cv2.resize(cv2.imread(each),(3968, 2976)) for each in filenames]
	...
	def leftshift(self):
		...
		for b in self.left_list[1:]:
			...
			dsize = (int(ds[0])+offsetx+1500, int(ds[1]) + offsety+1500)
...
if __name__ == '__main__':
	...
	s.rightshift()
	print ("done")
	cv2.imwrite("g1.jpg", s.leftImage)
	print ("image written")
