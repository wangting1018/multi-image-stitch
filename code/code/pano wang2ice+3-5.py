...
class Stitch:
	...
	def leftshift(self):
		...
		for b in self.left_list[1:]:
			...
			dsize = (int(ds[0])+offsetx+20+2, int(ds[1]) + offsety+20+2)
...
if __name__ == '__main__':
	try:
		...
		args = "txtlists/pano wang2ice+3-5.txt"
	finally:
	...
	s.rightshift()
	print ("done")
	cv2.imwrite("pano wang2ice+3-5.jpg", s.leftImage)
	print ("image written")
	cv2.imshow("pano wang2ice+3-5", s.leftImage)
	cv2.waitKey()
